...
import {CommentsRepository} from "./blogsLogic/comments/no-sql/comments.repository";
...
import {CommentsSQLRepository} from "./blogsLogic/comments/commentsSA.repository";
...
export class AppService {
  ...
  async removeAll() {
    ...
    await this.commentsSQLRepository.removeAllCommentsForTest();
    return
  }
}
